...
def collecte_brvm(avec_bilans=False):
    ...
    # La série de cours s'écrit avant tout le reste : c'est la seule donnée
    # de ce projet qu'une collecte manquée perd définitivement.
    points = brvm.archiver_cours(societes)
